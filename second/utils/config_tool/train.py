...
from second.protos.optimizer_pb2 import (ExponentialDecay, LearningRate,
                                         ManualStepping, OneCycle, Optimizer)
...
def exp_decay(train_config,
    ...
    optim_cfg.learning_rate.exponential_decay.CopyFrom(
        ExponentialDecay(initial_learning_rate=init_lr,
...
if __name__ == "__main__":
    path = Path(__file__).resolve().parents[2] / "configs/car.lite.proto"
