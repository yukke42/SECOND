...
_CLASSSETTING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.anchor_generator_stride',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.anchor_generator_range',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='no_anchor',
            full_name='second.protos.ClassSetting.no_anchor',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.region_similarity_calculator',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.use_multi_class_nms',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='use_rotate_nms',
            full_name='second.protos.ClassSetting.use_rotate_nms',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.nms_pre_max_size',
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.nms_post_max_size',
            index=7,
            number=8,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.nms_score_threshold',
            index=8,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.nms_iou_threshold',
            index=9,
            number=10,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.matched_threshold',
            index=10,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.unmatched_threshold',
            index=11,
            number=12,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='class_name',
            full_name='second.protos.ClassSetting.class_name',
            index=12,
            number=13,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ClassSetting.feature_map_size',
            index=13,
            number=14,
            type=3,
            cpp_type=2,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name='second.protos.ClassSetting.anchor_generator',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_TARGETASSIGNER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='class_settings',
            full_name='second.protos.TargetAssigner.class_settings',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.TargetAssigner.assign_per_class',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='nms_pre_max_sizes',
            full_name='second.protos.TargetAssigner.nms_pre_max_sizes',
            index=4,
            number=5,
            type=3,
            cpp_type=2,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='nms_post_max_sizes',
            full_name='second.protos.TargetAssigner.nms_post_max_sizes',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='nms_score_thresholds',
            full_name='second.protos.TargetAssigner.nms_score_thresholds',
            index=6,
            number=7,
            type=3,
            cpp_type=2,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='nms_iou_thresholds',
            full_name='second.protos.TargetAssigner.nms_iou_thresholds',
            index=7,
            number=8,
            type=3,
            cpp_type=2,
...
_CLASSSETTING.fields_by_name[
    'anchor_generator_stride'].message_type = second_dot_protos_dot_anchors__pb2._ANCHORGENERATORSTRIDE
_CLASSSETTING.fields_by_name[
    'anchor_generator_range'].message_type = second_dot_protos_dot_anchors__pb2._ANCHORGENERATORRANGE
_CLASSSETTING.fields_by_name[
    'no_anchor'].message_type = second_dot_protos_dot_anchors__pb2._NOANCHOR
_CLASSSETTING.fields_by_name[
    'region_similarity_calculator'].message_type = second_dot_protos_dot_similarity__pb2._REGIONSIMILARITYCALCULATOR
_CLASSSETTING.oneofs_by_name['anchor_generator'].fields.append(
    _CLASSSETTING.fields_by_name['anchor_generator_stride'])
_CLASSSETTING.fields_by_name[
    'anchor_generator_stride'].containing_oneof = _CLASSSETTING.oneofs_by_name[
        'anchor_generator']
_CLASSSETTING.oneofs_by_name['anchor_generator'].fields.append(
    _CLASSSETTING.fields_by_name['anchor_generator_range'])
_CLASSSETTING.fields_by_name[
    'anchor_generator_range'].containing_oneof = _CLASSSETTING.oneofs_by_name[
        'anchor_generator']
_CLASSSETTING.oneofs_by_name['anchor_generator'].fields.append(
    _CLASSSETTING.fields_by_name['no_anchor'])
_CLASSSETTING.fields_by_name[
    'no_anchor'].containing_oneof = _CLASSSETTING.oneofs_by_name[
        'anchor_generator']
...
ClassSetting = _reflection.GeneratedProtocolMessageType(
    'ClassSetting',
    (_message.Message, ),
    dict(DESCRIPTOR=_CLASSSETTING,
...
TargetAssigner = _reflection.GeneratedProtocolMessageType(
    'TargetAssigner',
    (_message.Message, ),
    dict(DESCRIPTOR=_TARGETASSIGNER,
         __module__='second.protos.target_pb2'
