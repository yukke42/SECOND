...
_DATABASEPREPROCESSINGSTEP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.DatabasePreprocessingStep.filter_by_difficulty',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.DatabasePreprocessingStep.filter_by_min_num_points',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name=
            'second.protos.DatabasePreprocessingStep.database_preprocessing_step',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_DBFILTERBYMINNUMPOINTINGROUNDTRUTH_MINNUMPOINTPAIRSENTRY = _descriptor.Descriptor(
    ...
    full_name=
    'second.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name=
            'second.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry.value',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_DBFILTERBYMINNUMPOINTINGROUNDTRUTH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.DBFilterByMinNumPointInGroundTruth.min_num_point_pairs',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _DBFILTERBYMINNUMPOINTINGROUNDTRUTH_MINNUMPOINTPAIRSENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_DATABASEPREPROCESSINGSTEP.fields_by_name[
    'filter_by_difficulty'].message_type = _DBFILTERBYDIFFICULTY
_DATABASEPREPROCESSINGSTEP.fields_by_name[
    'filter_by_min_num_points'].message_type = _DBFILTERBYMINNUMPOINTINGROUNDTRUTH
_DATABASEPREPROCESSINGSTEP.oneofs_by_name[
    'database_preprocessing_step'].fields.append(
        _DATABASEPREPROCESSINGSTEP.fields_by_name['filter_by_difficulty'])
_DATABASEPREPROCESSINGSTEP.fields_by_name[
    'filter_by_difficulty'].containing_oneof = _DATABASEPREPROCESSINGSTEP.oneofs_by_name[
        'database_preprocessing_step']
_DATABASEPREPROCESSINGSTEP.oneofs_by_name[
    'database_preprocessing_step'].fields.append(
        _DATABASEPREPROCESSINGSTEP.fields_by_name['filter_by_min_num_points'])
_DATABASEPREPROCESSINGSTEP.fields_by_name[
    'filter_by_min_num_points'].containing_oneof = _DATABASEPREPROCESSINGSTEP.oneofs_by_name[
        'database_preprocessing_step']
...
_DBFILTERBYMINNUMPOINTINGROUNDTRUTH.fields_by_name[
    'min_num_point_pairs'].message_type = _DBFILTERBYMINNUMPOINTINGROUNDTRUTH_MINNUMPOINTPAIRSENTRY
DESCRIPTOR.message_types_by_name[
    'DatabasePreprocessingStep'] = _DATABASEPREPROCESSINGSTEP
DESCRIPTOR.message_types_by_name[
    'DBFilterByDifficulty'] = _DBFILTERBYDIFFICULTY
DESCRIPTOR.message_types_by_name[
    'DBFilterByMinNumPointInGroundTruth'] = _DBFILTERBYMINNUMPOINTINGROUNDTRUTH
...
_sym_db.RegisterMessage(
    DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry)
