...
_VOXELNET_LOSSNORMTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name='NormByNumExamples',
                                        index=0,
                                        number=0,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='NormByNumPositives',
                                        index=1,
                                        number=1,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='NormByNumPosNeg',
                                        index=2,
                                        number=2,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='DontNorm',
                                        index=3,
                                        number=3,
                                        serialized_options=None,
                                        type=None),
...
_VOXELNET_VOXELFEATUREEXTRACTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='num_filters',
            full_name=
            'second.protos.VoxelNet.VoxelFeatureExtractor.num_filters',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='with_distance',
            full_name=
            'second.protos.VoxelNet.VoxelFeatureExtractor.with_distance',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='num_input_features',
            full_name=
            'second.protos.VoxelNet.VoxelFeatureExtractor.num_input_features',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_VOXELNET_MIDDLEFEATUREEXTRACTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.VoxelNet.MiddleFeatureExtractor.num_filters_down1',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.VoxelNet.MiddleFeatureExtractor.num_filters_down2',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='num_input_features',
            full_name=
            'second.protos.VoxelNet.MiddleFeatureExtractor.num_input_features',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.VoxelNet.MiddleFeatureExtractor.downsample_factor',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_VOXELNET_RPN = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='num_input_features',
            full_name='second.protos.VoxelNet.RPN.num_input_features',
            index=8,
            number=9,
            type=5,
            cpp_type=1,
...
_VOXELNET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.VoxelNet.network_class_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None,
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='rpn',
                                    full_name='second.protos.VoxelNet.rpn',
                                    index=4,
                                    number=5,
                                    type=11,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.VoxelNet.direction_offset',
            index=18,
            number=19,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='sin_error_factor',
            full_name='second.protos.VoxelNet.sin_error_factor',
            index=19,
            number=20,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='nms_class_agnostic',
            full_name='second.protos.VoxelNet.nms_class_agnostic',
            index=20,
            number=21,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='num_direction_bins',
            full_name='second.protos.VoxelNet.num_direction_bins',
            index=21,
            number=22,
            type=3,
            cpp_type=2,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='direction_limit_offset',
            full_name='second.protos.VoxelNet.direction_limit_offset',
            index=22,
            number=23,
            type=2,
            cpp_type=6,
...
_VOXELNET.fields_by_name[
    'voxel_generator'].message_type = second_dot_protos_dot_voxel__generator__pb2._VOXELGENERATOR
_VOXELNET.fields_by_name[
    'voxel_feature_extractor'].message_type = _VOXELNET_VOXELFEATUREEXTRACTOR
_VOXELNET.fields_by_name[
    'middle_feature_extractor'].message_type = _VOXELNET_MIDDLEFEATUREEXTRACTOR
_VOXELNET.fields_by_name['rpn'].message_type = _VOXELNET_RPN
_VOXELNET.fields_by_name[
    'loss'].message_type = second_dot_protos_dot_losses__pb2._LOSS
_VOXELNET.fields_by_name['loss_norm_type'].enum_type = _VOXELNET_LOSSNORMTYPE
_VOXELNET.fields_by_name[
    'box_coder'].message_type = second_dot_protos_dot_box__coder__pb2._BOXCODER
_VOXELNET.fields_by_name[
    'target_assigner'].message_type = second_dot_protos_dot_target__pb2._TARGETASSIGNER
