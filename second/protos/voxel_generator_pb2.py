...
_VOXELGENERATOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.VoxelGenerator.max_number_of_points_per_voxel',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='full_empty_part_with_mean',
            full_name='second.protos.VoxelGenerator.full_empty_part_with_mean',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.VoxelGenerator.block_filtering',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='block_factor',
            full_name='second.protos.VoxelGenerator.block_factor',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='block_size',
            full_name='second.protos.VoxelGenerator.block_size',
            index=6,
            number=7,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.VoxelGenerator.height_threshold',
            index=7,
            number=8,
            type=2,
            cpp_type=6,
...
VoxelGenerator = _reflection.GeneratedProtocolMessageType(
    'VoxelGenerator',
    (_message.Message, ),
    dict(DESCRIPTOR=_VOXELGENERATOR,
