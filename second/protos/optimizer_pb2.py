...
_OPTIMIZER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='fixed_weight_decay',
            full_name='second.protos.Optimizer.fixed_weight_decay',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
...
_MOMENTUMOPTIMIZER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='momentum_optimizer_value',
            full_name=
            'second.protos.MomentumOptimizer.momentum_optimizer_value',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_ADAMOPTIMIZER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='amsgrad',
            full_name='second.protos.AdamOptimizer.amsgrad',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_LEARNINGRATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='multi_phase',
            full_name='second.protos.LearningRate.multi_phase',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='one_cycle',
            full_name='second.protos.LearningRate.one_cycle',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.LearningRate.exponential_decay',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='manual_stepping',
            full_name='second.protos.LearningRate.manual_stepping',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_LEARNINGRATEPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='start',
            full_name='second.protos.LearningRatePhase.start',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='lambda_func',
            full_name='second.protos.LearningRatePhase.lambda_func',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='momentum_lambda_func',
            full_name='second.protos.LearningRatePhase.momentum_lambda_func',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_MULTIPHASE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='phases',
            full_name='second.protos.MultiPhase.phases',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ONECYCLE = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='lr_max',
                                    full_name='second.protos.OneCycle.lr_max',
                                    index=0,
                                    number=1,
                                    type=2,
                                    cpp_type=6,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='moms',
                                    full_name='second.protos.OneCycle.moms',
                                    index=1,
                                    number=2,
                                    type=2,
                                    cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='div_factor',
            full_name='second.protos.OneCycle.div_factor',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='pct_start',
            full_name='second.protos.OneCycle.pct_start',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_EXPONENTIALDECAY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.ExponentialDecay.initial_learning_rate',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='decay_length',
            full_name='second.protos.ExponentialDecay.decay_length',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='decay_factor',
            full_name='second.protos.ExponentialDecay.decay_factor',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='staircase',
            full_name='second.protos.ExponentialDecay.staircase',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
_MANUALSTEPPING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='boundaries',
            full_name='second.protos.ManualStepping.boundaries',
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='rates',
            full_name='second.protos.ManualStepping.rates',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_LEARNINGRATE.fields_by_name[
    'exponential_decay'].message_type = _EXPONENTIALDECAY
...
_LEARNINGRATE.fields_by_name[
    'multi_phase'].containing_oneof = _LEARNINGRATE.oneofs_by_name[
        'learning_rate']
_LEARNINGRATE.oneofs_by_name['learning_rate'].fields.append(
    _LEARNINGRATE.fields_by_name['one_cycle'])
_LEARNINGRATE.fields_by_name[
    'one_cycle'].containing_oneof = _LEARNINGRATE.oneofs_by_name[
        'learning_rate']
_LEARNINGRATE.oneofs_by_name['learning_rate'].fields.append(
    _LEARNINGRATE.fields_by_name['exponential_decay'])
_LEARNINGRATE.fields_by_name[
    'exponential_decay'].containing_oneof = _LEARNINGRATE.oneofs_by_name[
        'learning_rate']
_LEARNINGRATE.oneofs_by_name['learning_rate'].fields.append(
    _LEARNINGRATE.fields_by_name['manual_stepping'])
_LEARNINGRATE.fields_by_name[
    'manual_stepping'].containing_oneof = _LEARNINGRATE.oneofs_by_name[
        'learning_rate']
...
RMSPropOptimizer = _reflection.GeneratedProtocolMessageType(
    'RMSPropOptimizer',
    (_message.Message, ),
    dict(DESCRIPTOR=_RMSPROPOPTIMIZER,
         __module__='second.protos.optimizer_pb2'
...
AdamOptimizer = _reflection.GeneratedProtocolMessageType(
    'AdamOptimizer',
    (_message.Message, ),
    dict(DESCRIPTOR=_ADAMOPTIMIZER,
         __module__='second.protos.optimizer_pb2'
...
MultiPhase = _reflection.GeneratedProtocolMessageType(
    'MultiPhase',
    (_message.Message, ),
    dict(DESCRIPTOR=_MULTIPHASE,
         __module__='second.protos.optimizer_pb2'
         # @@protoc_insertion_point(class_scope:second.protos.MultiPhase)
         ))
_sym_db.RegisterMessage(MultiPhase)

OneCycle = _reflection.GeneratedProtocolMessageType(
    'OneCycle',
    (_message.Message, ),
    dict(DESCRIPTOR=_ONECYCLE,
         __module__='second.protos.optimizer_pb2'
         # @@protoc_insertion_point(class_scope:second.protos.OneCycle)
         ))
_sym_db.RegisterMessage(OneCycle)

ExponentialDecay = _reflection.GeneratedProtocolMessageType(
    'ExponentialDecay',
    (_message.Message, ),
    dict(DESCRIPTOR=_EXPONENTIALDECAY,
         __module__='second.protos.optimizer_pb2'
         # @@protoc_insertion_point(class_scope:second.protos.ExponentialDecay)
         ))
_sym_db.RegisterMessage(ExponentialDecay)

ManualStepping = _reflection.GeneratedProtocolMessageType(
    'ManualStepping',
    (_message.Message, ),
    dict(DESCRIPTOR=_MANUALSTEPPING,
         __module__='second.protos.optimizer_pb2'
