...
_INPUTREADER_DATASET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.InputReader.Dataset.kitti_info_path',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.InputReader.Dataset.kitti_root_path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.InputReader.Dataset.dataset_class_name',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_INPUTREADER_PREPROCESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='shuffle_points',
            full_name='second.protos.InputReader.Preprocess.shuffle_points',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.max_number_of_voxels',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.groundtruth_localization_noise_std',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.groundtruth_rotation_uniform_noise',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.global_rotation_uniform_noise',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.global_scaling_uniform_noise',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='global_translate_noise_std',
            full_name=
            'second.protos.InputReader.Preprocess.global_translate_noise_std',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.remove_unknown_examples',
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='num_workers',
            full_name='second.protos.InputReader.Preprocess.num_workers',
            index=8,
            number=9,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.anchor_area_threshold',
            index=9,
            number=10,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.remove_points_after_sample',
            index=10,
            number=11,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.groundtruth_points_drop_percentage',
            index=11,
            number=12,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.groundtruth_drop_max_keep_points',
            index=12,
            number=13,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.InputReader.Preprocess.remove_environment',
            index=13,
            number=14,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.global_random_rotation_range_per_object',
            index=14,
            number=15,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.InputReader.Preprocess.database_prep_steps',
            index=15,
            number=16,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='second.protos.InputReader.Preprocess.database_sampler',
            index=16,
            number=17,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='use_group_id',
            full_name='second.protos.InputReader.Preprocess.use_group_id',
            index=17,
            number=18,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='min_num_of_points_in_gt',
            full_name=
            'second.protos.InputReader.Preprocess.min_num_of_points_in_gt',
            index=18,
            number=19,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='random_flip_x',
            full_name='second.protos.InputReader.Preprocess.random_flip_x',
            index=19,
            number=20,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='random_flip_y',
            full_name='second.protos.InputReader.Preprocess.random_flip_y',
            index=20,
            number=21,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='sample_importance',
            full_name='second.protos.InputReader.Preprocess.sample_importance',
            index=21,
            number=22,
            type=2,
            cpp_type=6,
...
_INPUTREADER = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _INPUTREADER_DATASET,
        _INPUTREADER_PREPROCESS,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_INPUTREADER_PREPROCESS.fields_by_name[
    'database_prep_steps'].message_type = second_dot_protos_dot_preprocess__pb2._DATABASEPREPROCESSINGSTEP
_INPUTREADER_PREPROCESS.fields_by_name[
    'database_sampler'].message_type = second_dot_protos_dot_sampler__pb2._SAMPLER
...
_INPUTREADER.fields_by_name[
    'preprocess'].message_type = _INPUTREADER_PREPROCESS
