...
_TRAINEVALPIPELINECONFIG = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.TrainEvalPipelineConfig.train_input_reader',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_TRAINEVALPIPELINECONFIG.fields_by_name[
    'model'].message_type = second_dot_protos_dot_model__pb2._DETECTIONMODEL
_TRAINEVALPIPELINECONFIG.fields_by_name[
    'train_input_reader'].message_type = second_dot_protos_dot_input__reader__pb2._INPUTREADER
_TRAINEVALPIPELINECONFIG.fields_by_name[
    'train_config'].message_type = second_dot_protos_dot_train__pb2._TRAINCONFIG
_TRAINEVALPIPELINECONFIG.fields_by_name[
    'eval_input_reader'].message_type = second_dot_protos_dot_input__reader__pb2._INPUTREADER
