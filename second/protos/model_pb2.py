...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        second_dot_protos_dot_second__pb2.DESCRIPTOR,
    ])
...
_DETECTIONMODEL.fields_by_name[
    'second'].message_type = second_dot_protos_dot_second__pb2._VOXELNET
_DETECTIONMODEL.oneofs_by_name['model'].fields.append(
    _DETECTIONMODEL.fields_by_name['second'])
_DETECTIONMODEL.fields_by_name[
    'second'].containing_oneof = _DETECTIONMODEL.oneofs_by_name['model']
...
DetectionModel = _reflection.GeneratedProtocolMessageType(
    'DetectionModel',
    (_message.Message, ),
    dict(DESCRIPTOR=_DETECTIONMODEL,
