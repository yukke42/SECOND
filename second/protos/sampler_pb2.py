...
_SAMPLER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'second.protos.Sampler.global_random_rotation_range_per_object',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_GROUP.fields_by_name[
    'name_to_max_num'].message_type = _GROUP_NAMETOMAXNUMENTRY
