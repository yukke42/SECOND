...
class TargetAssigner:
    ...
    def assign(self,
        ...
        if self._assign_per_class:
            return self.assign_per_class(anchors_dict,
                                         gt_boxes,
                                         anchors_mask,
                                         gt_classes,
                                         gt_names,
            ...
            return self.assign_all(anchors,
                                   gt_boxes,
                                   anchors_mask,
                                   gt_classes,
                                   matched_thresholds,
    ...
    def assign_per_class(self,
        ...
        for class_name, anchor_dict in anchors_dict.items():
            ...
            if anchors_mask is not None:
                ...
                anchors_mask_class = anchors_mask[a_range[0]:
                                                  a_range[1]].reshape(-1)
    ...
    def generate_anchors(self, feature_map_size):
        ...
        if self._feature_map_sizes is not None:
            ...
            feature_map_sizes = [feature_map_size] * len(
    ...
    def generate_anchors_dict(self, feature_map_size):
        ...
        for anchor_generator, match_thresh, unmatch_thresh, fsize in zip(
            ...
            anchors_dict[class_name]["anchors"] = anchors.reshape(
                -1, self.box_ndim)
    ...
    def anchors_range(self, class_name):
        ...
        for name in self._classes:
            anchor_ranges.append(
                (num_anchors, num_anchors + self.num_anchors(name)))
